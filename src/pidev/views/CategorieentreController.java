 ...
 * @author HP
 */
public class CategorieentreController implements Initializable {

    @FXML
    private Circle btnClose;
    @FXML
    private Label rec;
    private TableView<categorie> depot;
    private TableColumn<categorie,String> datedebut;
    private TableColumn<categorie,Integer> iddepot;
 ...
 ObservableList<categorie>observableList;
    ...
    private void Ajouter(ActionEvent event) throws IOException {
        ...
        loader.setLocation(getClass().getResource("AjouterProduit.fxml"));
         //idcat=table.getSelectionModel().getSelectedItem().getId().toString();
          //System.out.println("bmabla***********"+idcat);
